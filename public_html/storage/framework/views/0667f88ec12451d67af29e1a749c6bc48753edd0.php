        ...
        <div class="card  bg-white mt-1 ml-2">
            ...
            <div class="card-header row">
                    ...
                    <div class="col-md-4">
                        ...
                        <form action="<?php echo e(route('shipping.export_excel')); ?>" class="form form-inline" method="POST">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <label><b>Shipping cost / ค่าขนส่ง</b></label>

                                        <input type="number" class="form-control" name="shipping_cost" required value="" placeholder="ค่าขนส่ง">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-responsive-md">
                        ...
                        <tbody>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $shipping; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($value->shipping_cost); ?></td>

                                    <td><a href="<?php echo e(route('shipping.destroy',$value->id)); ?>" onclick="return confirm('Are you Sure?')" class="text-danger">delete</a></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zkads/domains/zkads.com/public_html/resources/views/admin/shipping/index.blade.php ENDPATH**/ ?>