        ...
        <div class="card  bg-white mt-1 ml-2">
            ...
            <div class="card-header row">
                    ...
                    <div class="col-md-4">
                        ...
                        <form action="<?php echo e(route('advertising.export_excel')); ?>" class="form form-inline" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="basic-form">
                    ...
                    <form action="<?php echo e(route('advertising.store')); ?>" method="POST">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <label><b>Advertising cost / ค่าโฆษณา</b></label>

                                        <input type="number" class="form-control" name="advert" required value="" placeholder="ค่าโฆษณา">
                    ...
                    <table class="table table-bordered table-responsive-md">
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <th>Advertising cost / ค่าโฆษณา</th>
                        ...
                        <tbody>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $advertising; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <?php if(isset($page)): ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e(explode('=',$value->page_campaign_name)[1]); ?> = <?php echo e(explode('=',$value->page_campaign_name)[2]); ?></td>

                                    <td><?php echo e($value->advert); ?></td>

                                    <td><a href="<?php echo e(route('advertising.destroy',$value->id)); ?>" onclick="return confirm('Are you Sure?')" class="text-danger">delete</a></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zkads/domains/zkads.com/public_html/resources/views/admin/advertising/index.blade.php ENDPATH**/ ?>