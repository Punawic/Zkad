            ...
            <div class="card-header row">
                ...
                {{-- <div class="row"> --}}
                    ...
                    <div class="col-md-4">
                        ...
                        <form action="{{ route('shipping.export_excel') }}" class="form form-inline" method="POST">
                        ...
                        <tbody>
                            ...
                            @forelse ($shipping as $key => $value)
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('shipping.destroy',$value->id) }}" onclick="return confirm('Are you Sure?')" class="text-danger">delete</a></td>
