            ...
            <div class="card-header row">
                ...
                {{-- <div class="row"> --}}
                    ...
                    <div class="col-md-4">
                        ...
                        <form action="{{ route('advertising.export_excel') }}" class="form form-inline" method="POST">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-responsive-md">
                        ...
                        <tbody>
                            ...
                            @forelse ($advertising as $key => $value)
                            ...
                            @if (isset($page))
                                ...
                                <tr>
                                    ...
                                    <td>{{ explode('=',$value->page_campaign_name)[1] }} = {{ explode('=',$value->page_campaign_name)[2] }}</td>

                                    <td>{{ $value->advert }}</td>

                                    <td><a href="{{ route('advertising.destroy',$value->id) }}" onclick="return confirm('Are you Sure?')" class="text-danger">delete</a></td>
